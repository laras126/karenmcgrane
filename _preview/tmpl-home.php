...
?>
    ...
    <div class="region content-main has-sidebar">
        <div class="group p-more">
            <h2 class="hed-section">Recent Articles</h2>
            ...
            <h2 class="hed-section">Recent Talks</h2>
        ...
        <div class="group-alt p-less">
            <h2 class="hed-section">Recent Sources</h2>
